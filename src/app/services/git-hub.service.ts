...
export class GitHubService {
  private username = 'ggsolomon';
  private client_id = '726b38fda4b044daac69';
  private client_secret: any = ' 407f535aaa5fae9fc208acb4baf8f25b02864027';
  private base_url: string = 'https://api.github.com';
  private api_v3: string = 'application/vnd.github.v3+json';
  private search_limit:number = 900000; // users search limit
